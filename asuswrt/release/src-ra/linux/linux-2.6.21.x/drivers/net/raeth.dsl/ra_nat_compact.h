...
enum DstPort {
    ...
    DP_RAI0=24,
#if defined (CONFIG_RT3090_AP_MBSS) || defined (CONFIG_RTPCI_AP_MBSS)
    DP_RAI1=25,
    DP_RAI2=26,
    DP_RAI3=27,
    DP_RAI4=28,
...
#if defined (CONFIG_RT3090_AP_WDS) || defined (CONFIG_RTPCI_AP_WDS)
    DP_WDSI0=40,
    DP_WDSI1=41,
    DP_WDSI2=42,
    DP_WDSI3=43,
#endif // CONFIG_RT3090_AP_WDS //
#if defined (CONFIG_RT3090_AP_APCLI) || defined (CONFIG_RTPCI_AP_APCLI)
    DP_APCLII0=44,
#endif // CONFIG_RT3090_AP_APCLI //
#if defined (CONFIG_RT3090_AP_MESH) || defined (CONFIG_RTPCI_AP_MESH)
    DP_MESHI0=45,
