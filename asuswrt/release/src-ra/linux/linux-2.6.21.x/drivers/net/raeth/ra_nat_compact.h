...
enum DstPort {
	...
	DP_RAI0 = 33,
#if defined (CONFIG_RTPCI_AP_MBSS) || defined (CONFIG_RT5392_AP_MBSS) || \
...
#if defined (CONFIG_RTPCI_AP_WDS) || defined (CONFIG_RT5392_AP_WDS) || \
...
#if defined (CONFIG_RTPCI_AP_APCLI) || defined (CONFIG_RT5392_AP_APCLI) || \
...
#if defined (CONFIG_RTPCI_AP_MESH) || defined (CONFIG_RT5392_AP_MESH) || \
