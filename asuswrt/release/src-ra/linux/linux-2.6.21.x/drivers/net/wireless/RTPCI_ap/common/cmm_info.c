...
//    	return "WPA";
	return "WPA-Enterprise";	// ASUS EXT
    if(auth == Ndis802_11AuthModeWPAPSK)
//    	return "WPAPSK";
	return "WPA-Personal";		// ASUS EXT
    if(auth == Ndis802_11AuthModeWPANone)
    	return "WPANONE";
    if(auth == Ndis802_11AuthModeWPA2)
//    	return "WPA2";
	return "WPA2-Enterprise";	// ASUS EXT
    if(auth == Ndis802_11AuthModeWPA2PSK)
//    	return "WPA2PSK";
	return "WPA2-Personal";		// ASUS EXT
...
#define LINE_LEN	(4+33+18+9+16+9+8)	/* Channel+SSID+Bssid+EncryptType+AuthMode+Signal+WiressMode*/	// ASUS EXT
...
//	sprintf(msg+strlen(msg),"%02x:%02x:%02x:%02x:%02x:%02x   ", 
	sprintf(msg+strlen(msg),"%02X:%02X:%02X:%02X:%02X:%02X ",	// ASUS EXT
		pBss->Bssid[0], 
		pBss->Bssid[1],
		pBss->Bssid[2], 
		pBss->Bssid[3], 
...
//		sprintf(SecurityStr, "%s/%s", GetAuthMode((CHAR)ap_auth_mode), GetEncryptType((CHAR)ap_cipher));
		sprintf(SecurityStr+strlen(SecurityStr),"%-9s", GetEncryptType((CHAR)ap_cipher));	// ASUS EXT
		sprintf(SecurityStr+strlen(SecurityStr),"%-16s", GetAuthMode((CHAR)ap_auth_mode));	// ASUS EXT
	}
	else
	{
		ap_auth_mode = pBss->AuthMode;
...
//			sprintf(SecurityStr, "NONE");
			sprintf(SecurityStr, "NONE     Open System");	// ASUS EXT
		else if (ap_cipher == Ndis802_11WEPEnabled)
//			sprintf(SecurityStr, "WEP");
			sprintf(SecurityStr, "WEP      Unknown");	// ASUS EXT
		else
		{
//			sprintf(SecurityStr, "%s/%s", GetAuthMode((CHAR)ap_auth_mode), GetEncryptType((CHAR)ap_cipher));
			sprintf(SecurityStr+strlen(SecurityStr),"%-9s", GetEncryptType((CHAR)ap_cipher));	// ASUS EXT
...
//		sprintf(msg+strlen(msg),"%-7s", "11b");
		sprintf(msg+strlen(msg),"%-8s", "11b");		// ASUS EXT
	else if (wireless_mode == Ndis802_11OFDM5)
//		sprintf(msg+strlen(msg),"%-7s", "11a");
		sprintf(msg+strlen(msg),"%-8s", "11a");		// ASUS EXT
	else if (wireless_mode == Ndis802_11OFDM5_N)
//		sprintf(msg+strlen(msg),"%-7s", "11a/n");
		sprintf(msg+strlen(msg),"%-8s", "11a/n");	// ASUS EXT
	else if (wireless_mode == Ndis802_11OFDM24)
//		sprintf(msg+strlen(msg),"%-7s", "11b/g");
		sprintf(msg+strlen(msg),"%-8s", "11b/g");	// ASUS EXT
	else if (wireless_mode == Ndis802_11OFDM24_N)
//		sprintf(msg+strlen(msg),"%-7s", "11b/g/n");
		sprintf(msg+strlen(msg),"%-8s", "11b/g/n");	// ASUS EXT
	else
//		sprintf(msg+strlen(msg),"%-7s", "unknow");
		sprintf(msg+strlen(msg),"%-8s", "unknown");	// ASUS EXT
#if 0								// ASUS EXT
	/* Ext Channel*/
...
//	    "Ch", "SSID", "BSSID", "Security", "Siganl(%)", "W-Mode", " ExtCH"," NT");
	...
	for(i=0; i<pAdapter->ScanTab.BssNr ;i++)
	{
		...
		if (pBss->BssType == BSS_ADHOC)	// ASUS EXT
			continue;
