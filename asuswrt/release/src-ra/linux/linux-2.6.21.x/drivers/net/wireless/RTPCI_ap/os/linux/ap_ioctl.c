...
/* end of modification */
		...
		case RTPRIV_IOCTL_ASUSCMD:
			switch(wrq->u.data.flags) {
				case ASUS_SUBCMD_GSTAINFO:	// ASUS EXT by Jiahao
					RTMPIoctlGetSTAINFO(pAd,wrq);
					break;

				case ASUS_SUBCMD_GSTAT:		// ASUS EXT by Jiahao
					RTMPIoctlGetSTAT(pAd,wrq);
					break;

				case ASUS_SUBCMD_GRSSI:		// ASUS EXT by Jiahao
					RTMPIoctlGetRSSI(pAd,wrq);
					break;

				case ASUS_SUBCMD_RADIO_STATUS:
					RTMPIoctlGetRadioStatus(pAd,wrq);
					break;

				case ASUS_SUBCMD_CHLIST:
					RTMPIoctlGetChannelList(pAd,wrq);
					break;
